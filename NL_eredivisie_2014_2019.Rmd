...
```{r raw_data, cache = 2, cache.extra = file.info(list.files(path = "test", pattern = ".csv", full.names = TRUE))}
from_year <- 2014
to_year <- 2019
...
```{r monte_carlo, cache=2, dependson="processed_data", cache.extra = "jags_model_description", results='hide'}
# Compiling the model
